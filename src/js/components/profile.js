class Profile extends HTMLElement {
  constructor() {
    ...
    <div class='posts'>
    <div class='post'>
    <img class='postImg' src="/vanilla-spa-rep/land.jpg" alt='ss' /> 
         <div class='postComment'>
         <img src='/vanilla-spa-rep/icons/union.png' alt='ss'/>
            <p style='display: inline; padding: 5px; color: #5095EC'>Jason Anderson</p>commented:
               ...
               <div style="padding-top: 15px">
                  <img  src='/vanilla-spa-rep/icons/view.png' alt='ss' />
    ...
    <div class='wrapper'>
    <div class='user'>
    <img class='ava' src="/vanilla-spa-rep/avatarka.png" alt='ss' />
    <div class='userInfo'>
      <p>Hanna Dorman</p>
      <p style='font-size: 14px; color: #8F8F8F;'>UX/UI designer</p>
      <div class='logos'>
      <img src='/vanilla-spa-rep/icons/tg.png' alt='ss' />
      <img src='/vanilla-spa-rep/icons/tg.png' alt='ss' />
      <img src='/vanilla-spa-rep/icons/twitter.png' alt='ss' />
      </div>
    </div>
    </div>
    </div>
    ...
    <p>Navigation</p><img src="/vanilla-spa-rep/icons/up.png" alt='ss' />
    </div>
    <hr/>
    <div>
    <img src="/vanilla-spa-rep/icons/person.png" alt='ss' />
    <a class='navA'>My Profile</a>
    </div> 
    <div>
    <img src="/vanilla-spa-rep/icons/balance.png" alt='ss' />
    <a class='navA'>Balance</a>
    </div>
    <div>
    <img src="/vanilla-spa-rep/icons/schema.png" alt='ss' />
    <a class='navA'>Connections</a>
    </div>
    <div>
    <img src="/vanilla-spa-rep/icons/friends.png"  alt='ss' />
    <a class='navA'>Friends</a>
    </div>
    <hr/>
    <div>
    <img src="/vanilla-spa-rep/icons/events.png" alt='ss' />
    <a class='navA'>Events</a>
    </div>
    <div>
    <img src="/vanilla-spa-rep/icons/settings.png" alt='ss' />
    ...
    <div class='shareWrap'>
    <div class='navigationarrow'>
    <p>Share your thougths</p><img src="/vanilla-spa-rep/icons/up.png" alt='ss' />
    </div>
    <hr/>
